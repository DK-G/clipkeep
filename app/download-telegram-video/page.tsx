...
import { telegramText, normalizeLocale, menuText } from '@/lib/i18n/ui';
...
export default async function TelegramDownloaderPage({ searchParams }: Props) {
  ...
  const websiteUrl = `${SITE_URL}/download-telegram-video?locale=${locale}`;
    ...
    '@graph': [
      {
        ...
        featureList: 'Fast Telegram media extraction, Public channel support, Secure downloads',
        description: t.subtitle,
        aggregateRating: {
