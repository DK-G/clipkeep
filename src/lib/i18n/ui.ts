...
export const homeText: Record<Locale, HomeDict> = {
  en: {
    ...
    threadsDesc: "Archive videos and media from Threads (Instagram) posts.",
  ...
  ja: {
    ...
    threadsDesc: "Threads (Instagram) の投稿から動画やメディアをアーカイブします。",
  ...
  es: {
    ...
    threadsDesc: "Archiva videos y medios de publicaciones de Threads (Instagram).",
  ...
  pt: {
    ...
    threadsDesc: "Arquive vídeos e mídias de postagens do Threads (Instagram).",
  ...
  fr: {
    ...
    threadsDesc: "Archivez des vidéos et des médias des publications Threads (Instagram).",
  ...
  id: {
    ...
    threadsDesc: "Arsipkan video dan media dari postingan Threads (Instagram).",
  ...
  hi: {
    ...
    threadsDesc: "Threads (Instagram) पोस्ट से वीडियो और मीडिया आर्काइव करें।",
  ...
  de: {
    ...
    threadsTitle: "Threads Downloader",
    threadsDesc: "Archivieren Sie Videos und Medien aus Threads (Instagram)-Posts.",
    blueskyTitle: "Bluesky Downloader",
  ...
  tr: {
    ...
    threadsDesc: "Threads (Instagram) gönderilerinden videoları ve medyayı arşivleyin.",
...
export const threadsText: Record<Locale, PlatformPageDict> = {
  en: {
    ...
    subtitle: "Archive videos and media from Threads (Instagram) posts.",
    statusLabel: "Status",
    helpPage: "Help Page",
  ...
  ja: {
    ...
    subtitle: "Threads (Instagram) の投稿から動画やメディアをアーカイブします。",
    statusLabel: "ステータス",
    helpPage: "ヘルプページ",
