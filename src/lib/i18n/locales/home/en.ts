...
export const en: HomeDict = {
    ...
    formTrustLine: "Public links only. No login, cookies, or account access required.",
    submitBlockedUrl: "Paste a public post URL to start.",
    submitBlockedSecurity: "Security check is loading. You can submit in a moment.",
    submitBlockedInstagram: "Instagram is under maintenance. Try TikTok or X instead.",
