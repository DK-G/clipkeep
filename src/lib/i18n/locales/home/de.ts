...
export const de: HomeDict = {
    ...
    formTrustLine: "Nur öffentliche Links. Kein Login, keine Cookies und kein Kontozugriff nötig.",
    submitBlockedUrl: "Füge eine öffentliche Beitrags-URL ein, um zu starten.",
    submitBlockedSecurity: "Die Sicherheitsprüfung lädt. Du kannst gleich senden.",
    submitBlockedInstagram: "Instagram wird gewartet. Probiere TikTok oder X.",
