...
export const id: HomeDict = {
    ...
    formTrustLine: "Hanya tautan publik. Tidak perlu login, cookie, atau akses akun.",
    submitBlockedUrl: "Tempel URL posting publik untuk mulai.",
    submitBlockedSecurity: "Pemeriksaan keamanan sedang dimuat. Anda bisa mengirim sebentar lagi.",
    submitBlockedInstagram: "Instagram sedang maintenance. Coba TikTok atau X.",
