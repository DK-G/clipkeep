...
interface TelegramDownloaderClientProps {
  locale: Locale;
}

export function TelegramDownloaderClient({ locale }: TelegramDownloaderClientProps) {
  ...
  return (
    <main dir={dir} className="max-w-4xl mx-auto px-6 py-12">
      ...
      <GallerySection id="realtime" platform="telegram" locale={locale} title="Real-time / リアルタイム" type="recent" />
      ...
      {t.trendingTitle && (
        <GallerySection id="trending" platform="telegram" locale={locale} title={t.trendingTitle} type="trending" />
      )}
